...
let
  # User public keys
  Maxwell = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILeccj+vW/qyKepgXK0oXZfVFMf1kwmqj4uBHmjU2fz8 Maxwell";
  ...
  g15 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILeaICX13Cw/ErM1Wag3P2letYRGXf3zIiuzPBQMlPAL root@nixos";
...
{
  # User passwords
  "secrets/user-password-Maxwell.age".publicKeys = allUsers ++ allHosts;
  ...
  "secrets/api-router-g15.age".publicKeys = allUsers ++ [ g15 ];
