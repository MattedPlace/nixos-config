...
in
{
  ...
  home.packages = with pkgs; [
    ...
    mpvpaper # static wallpaper for niri/labwc (Stylix only themes GNOME's bg)
  ...
  # system xkb.layout).
  programs.niri.settings.input.keyboard.xkb.layout = "us";
