...
#
# Runs Maxwell/backstage (a customised Spotify Backstage app) on p510
# alongside a sibling Postgres container. Image is consumed from
# ghcr.io/Maxwell/backstage, pinned to a SHA digest (NEVER :latest —
...
# See Maxwell/nixos_config epic #731.
...
in
{
  options.features.backstage = {
    ...
    image = lib.mkOption {
      type = lib.types.str;
      default = "ghcr.io/Maxwell/backstage@sha256:33a836eb6a7b8d45e5ef240e973ba2dd1856e377a31b1c952fa244b2d3dd70bc";
      example = "ghcr.io/Maxwell/backstage@sha256:abc123...";
      description = ''
