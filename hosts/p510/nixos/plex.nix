...
, ...
  ...
  systemd.tmpfiles.rules = [
    "d /mnt/media/prowlarr 0755 Maxwell users -"
    "d /mnt/media/downloads 0775 Maxwell users -"
    "d /mnt/media/downloads/torrents 0775 Maxwell users -"
    "d /mnt/media/downloads/torrents/complete 0775 Maxwell users -"
    "d /mnt/media/downloads/torrents/incomplete 0775 Maxwell users -"
    "d /mnt/media/downloads/torrents/watch 0775 Maxwell users -"
    "d /mnt/media/downloads/torrents/audiobooks 0775 Maxwell users -"
    "d /mnt/media/downloads/usenet 0775 Maxwell users -"
    "d /mnt/media/downloads/usenet/complete 0775 Maxwell users -"
    "d /mnt/media/downloads/usenet/incomplete 0775 Maxwell users -"
    "d /mnt/media/downloads/usenet/queue 0775 Maxwell users -"
    "d /mnt/media/downloads/usenet/tmp 0775 Maxwell users -"
    "d /mnt/media/Media/Downloads 0755 Maxwell users -"
    # AudioBookshelf directories
    "d /mnt/media/Media/Audiobooks 0755 Maxwell users -"
    "d /mnt/media/Media/Podcasts 0755 Maxwell users -"
    "d /mnt/media/audiobookshelf 0755 Maxwell users -"
    # SABnzbd isolated working dirs (side-by-side trial with NZBGet)
    "d /mnt/media/downloads/sabnzbd 0775 Maxwell users -"
    "d /mnt/media/downloads/sabnzbd/incomplete 0775 Maxwell users -"
    "d /mnt/media/downloads/sabnzbd/complete 0775 Maxwell users -"
    "d /mnt/media/downloads/sabnzbd/watch 0775 Maxwell users -"
  ];
  ...
  # The merge runs as root (ExecStartPre "+"), so 0400 Maxwell is fine.
  ...
  systemd.services.nzbget = {
    ...
    preStart = ''
      install -d -m 0700 -o Maxwell -g users /var/lib/nzbget
      install -m 0600 -o Maxwell -g users /dev/null /var/lib/nzbget/nzbget-secret.conf
