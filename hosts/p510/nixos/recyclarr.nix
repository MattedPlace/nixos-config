  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.recyclarr = {
      ...
      script = ''
        ...
        # TRaSH Guides setup, inlined per the modern Recyclarr v8 pattern
        # (bundle templates replaced the old include: chain). Source:
        #   recyclarr config create -t remux-web-1080p
        #   recyclarr config create -t web-1080p
        radarr:
          movies:
