...
in
{
  ...
  # k3d cluster — runs ArgoCD, watches github.com/Maxwell/factory-gitops
  ...
  features.ntfy = {
    ...
    #   ssh p510 -- sudo ntfy user add --role=admin Maxwell
    #   ssh p510 -- sudo ntfy user change-pass Maxwell
    #
