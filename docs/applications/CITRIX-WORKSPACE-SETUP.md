...
4. Place tarball in: `/home/Maxwell/.config/nixos/pkgs/citrix-workspace/`

```bash
# Create directory if it doesn't exist
mkdir -p /home/Maxwell/.config/nixos/pkgs/citrix-workspace/

# Move downloaded tarball
mv ~/Downloads/linuxx64-25.08.10.111.tar.gz /home/Maxwell/.config/nixos/pkgs/citrix-workspace/
```

### **Step 2: Add Tarball to Nix Store**

```bash
cd /home/Maxwell/.config/nixos/pkgs/citrix-workspace/
 ...
 **Warning**: This explicitly accepts the Citrix End User License Agreement. Review the EULA before enabling.
...
- **Obsidian Note**: `/home/Maxwell/Documents/Caliti/NixOS/Citrix-Workspace-Configuration.md`
- **Files**:
