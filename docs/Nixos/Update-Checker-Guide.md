...
services.nixos-update-checker = {
  enable = true;
  flakeDir = "/home/Maxwell/.config/nixos";
...
```bash
# 1. Check permissions
ls -ld /home/Maxwell/ /home/Maxwell/.config/

# 2. Add execute permission
chmod o+x /home/Maxwell/
chmod o+x /home/Maxwell/.config/

# 3. Verify service can access
sudo -u nixos-update-checker ls /home/Maxwell/.config/nixos/flake.lock
```
